...
import contactImage from '../assets/galleryImages/contactImage.jpg';
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className='flex flex-col items-center'>
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600">Looking for the best and most experienced décor professionals in Surat? <br />Get in touch with us without the slightest hesitation. Call us or fill up the form! <br />We'd love to hear from you!</p>
                </div>
                <div>
                    <img
                        src={contactImage}
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg">
                    <h2 className="text-center text-2xl font-bold text-gray-800 mb-4">We are here to Help You!</h2>
                    <p className="text-center text-gray-600 mb-6">Fill out the form and our team will get back to you within 24 hours.</p>
            ...
            <div className="relative rounded-2xl overflow-hidden group hover:shadow-[0_0_30px_rgba(236,72,153,1)]">
                ...
                <div className="absolute bottom-4 right-4 bg-white p-3 rounded-lg shadow-md flex items-center gap-2 z-10">
                    ...
                    <span className="text-sm font-medium text-gray-700">
                        Near, 110, Aagam Ochid,<br />
                        Nandan-2, Vesu, Surat,<br />
                        Gujarat 395007
                    </span>
                </div>
            </div>
