                ...
                <div className="grid md:grid-cols-2 gap-12">
                  <div className="space-y-6">
                    <p className="text-lg text-gray-600 leading-relaxed">
                      At Sunrise Events, we believe that every occasion deserves
                ...
                <div className="bg-red-300 rounded-2xl shadow-lg p-8 h-full">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-sm text-gray-600 m-10">
                      * Force majeure cancellations will be handled on a
                      case-by-case basis.
                    </p>
                  </div>
                </div>
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "By ensuring all staff are fully vaccinated and following all local health guidelines.",
  },
];
