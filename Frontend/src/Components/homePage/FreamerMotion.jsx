...
//   return (
//     <div className="flex flex-col items-center justify-center text-center px-4 my-4 sm:my-6 md:my-8">
//       {/* Stats Section */}
//       <motion.div
...
//         {/* Clients */}
//         <motion.div
//           className="pt-6 sm:pt-10 h-28 sm:h-40 w-full md:w-40 bg-white border-amber-200 border-4 rounded-3xl shadow-xl text-2xl sm:text-3xl md:text-4xl font-bold text-amber-600"
