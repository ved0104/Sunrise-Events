...
const FramerMotion = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 my-4 sm:my-6 md:my-8 w-full min-w-screen">
      {/* Stats Section */}
      <motion.div
        className="flex flex-col md:flex-row gap-8 min-w-60"
        whileInView={() => setStartCounting(true)} // Start counting when visible
        viewport={{ once: true }} // Ensures animation plays only once
      >
        {/* Clients */}
        <motion.div
          className="pt-6 sm:pt-10 h-28 sm:h-40 w-full md:w-40 shadow-xl text-2xl sm:text-3xl md:text-4xl font-bold text-amber-600"
