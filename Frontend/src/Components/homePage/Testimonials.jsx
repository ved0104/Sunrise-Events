              ...
              <div className="relative w-full max-w-[85vw] sm:max-w-[75vw] lg:max-w-[65vw] h-auto min-h-[40vh] sm:min-h-[50vh] lg:min-h-[60vh] flex justify-center items-center text-white">
                ...
                <div className="relative z-10 text-center px-4 sm:px-8">
                  <p className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl">
                    Absolutely stunning decor! Every detail was beautifully crafted, making our event truly magical!.
                  </p>
          ...
          <SwiperSlide>
            <div className="flex justify-center">
              <div className="relative w-full max-w-[85vw] sm:max-w-[75vw] lg:max-w-[65vw] h-auto min-h-[40vh] sm:min-h-[50vh] lg:min-h-[60vh] flex justify-center items-center text-white">
                ...
                <div className="relative z-10 text-center px-4 sm:px-8">
                  <p className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl">
                    Elegant and eye-catching! The decorations transformed the venue into dreamy, picture-perfect space.
                  </p>
                  <h2 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl mt-2">
                    - Parth
                  </h2>
          ...
          <SwiperSlide>
            <div className="flex justify-center">
              <div className="relative w-full max-w-[85vw] sm:max-w-[75vw] lg:max-w-[65vw] h-auto min-h-[40vh] sm:min-h-[50vh] lg:min-h-[60vh] flex justify-center items-center text-white">
                ...
                <div className="relative z-10 text-center px-4 sm:px-8">
                  <p className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl">
                    Highly professional and creative! they understood our vision and delivered beyond expectations.
                  </p>
                  <h2 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl mt-2">
                    - Sahil
                  </h2>
