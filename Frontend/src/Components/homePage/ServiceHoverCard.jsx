...
const HoverCard = () => {
  ...
  return (
      ...
      <div className="flex flex-row justify-center gap-6 my-8">
        <div className="border-amber-200 border-6 relative w-64 h-32 bg-white rounded-3xl overflow-hidden group flex items-center justify-center cursor-pointer hover:bg-blue-300 hover:underline" onClick={handleClick}>
