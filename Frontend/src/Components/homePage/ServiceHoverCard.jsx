...
const HoverCard = () => {
  ...
  return (
      ...
      <div className="flex flex-row justify-center gap-6 my-8">
        <div className="relative w-64 h-32 bg-white rounded-3xl shadow-2xl overflow-hidden group flex items-center justify-center cursor-pointer hover:bg-blue-300 hover:underline" onClick={handleClick}>
          <div className="absolute -right-6 -top-4 w-24 h-24 clip-custom1 transition-all duration-300 group-hover:w-64 group-hover:h-32 group-hover:bg-orange-500"></div>
        ...
        <div className="relative w-64 h-32 bg-white rounded-3xl shadow-2xl overflow-hidden group flex items-center justify-center cursor-pointer hover:bg-blue-300 hover:underline">
