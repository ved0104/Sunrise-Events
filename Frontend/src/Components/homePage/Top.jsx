...
export default function TopComponent() {
  ...
  return (
    <div className="min-h-100 sm:min-h-140 flex flex-col justify-center items-center pt-20 pb-8">  
      <div
        className="text-white flex flex-col items-center pt-11 bg-[url('/images/home/top4.jpg')] md:bg-[url('/images/home/top2.jpg')] bg-cover bg-center bg-no-repeat min-h-100 sm:min-h-140 min-w-full"
      >
