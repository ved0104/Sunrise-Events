  ...
  useEffect(() => {
    const importMedia = async () => {
      const mediaModules = import.meta.glob(
        "/src/assets/galleryImages/*.{jpg,jpeg,png,webp,mp4,mov,avi}"
      );
      ...
      const shuffledMedia = shuffleArray([
        ...remainingImages,
        ...videos.slice(1)
      ]);
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="md:col-span-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-gray-700">
              When a traditional mandap in full regalia meets modern floral artistry.
              A union that's decadent but still delightfully delicate.
            </p>
          </div>
          {[1, 2].map((index) => (
      ...
      {initialImages.length >= 4 && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-gray-700">
              This exquisite wooden masterpiece was hand-carved by India's finest artisans.
              Intricate details are bestowed upon each pillar. Delicate archways and
              double-pillared platforms give rise to a regal ambiance.
            </p>
          </div>
        </div>
      )}
      ...
      {featuredVideo && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-gray-700">
              Witness the seamless blend of traditional craftsmanship and modern design
              through our exclusive video showcase.
            </p>
          </div>
          <div className="relative md:col-span-2 group hover:shadow-[0_0_30px_rgba(236,72,153,1)] transition-shadow duration-300 rounded-lg">
            <video
      ...
      <div className="flex justify-center text-center mt-10">
        <div>
          ...
          <h2 className="text-3xl font-bold text-pink-600">Instagram</h2></div>
        <div>
          <p className="text-lg">Follow us on</p>
