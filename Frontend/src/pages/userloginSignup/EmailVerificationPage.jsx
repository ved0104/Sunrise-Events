	...
	return (
		<div className="flex flex-col min-h-screen justify-center items-center p-4">
			<motion.div
				...
				className='bg-amber-50 bg-opacity-50 backdrop-filter backdrop-blur-xl shadow-2xl p-6 md:p-8 w-full max-w-md'
			>
					...
					<div className='flex justify-between gap-2 md:gap-4'>
						{code.map((digit, index) => (
							<input
								...
								className='w-10 h-10 md:w-12 md:h-12 text-center text-xl md:text-2xl font-medium bg-white text-black border-2 border-gray-700 rounded-lg focus:border-amber-500 focus:outline-none'
							/>
						))}
					</div>
					<motion.button
						...
						className='w-full py-2 md:py-3 px-4 bg-gradient-to-r from-amber-200 to-amber-400 text-white font-bold rounded-lg shadow-lg hover:from-amber-300 hover:to-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-200 transition duration-200'
					>
