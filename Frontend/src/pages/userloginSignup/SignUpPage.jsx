	...
	return (
			...
			<div className="flex min-h-screen justify-center items-center p-4">
				<motion.div
					...
					className='flex flex-col md:flex-row bg-amber-50 bg-opacity-50 backdrop-filter backdrop-blur-xl shadow-xl 
				...
				>	
					<div className="h-64 md:h-[90vh] w-full md:w-1/2 bg-[url('assets/images/loginphotos/login.jpg')] bg-no-repeat bg-center bg-cover text-white">
						<h1 className="text-3xl md:text-5xl font-medium pt-5 pl-5">Register and Be<br/>part of our circle</h1>
					...
					<div className="w-full md:w-1/2">
						<div className='p-6 md:p-8'>
							<h2 className='text-2xl md:text-3xl font-bold mb-6 text-center bg-gradient-to-r from-amber-300 to-amber-500 text-transparent bg-clip-text'>
								Create Account
							</h2>
