		...
		<div className="flex flex-col min-h-screen justify-center items-center p-4">
		  ...
		  >
			<div className="p-6 md:p-8">
			  ...
			  {!isSubmitted ? (
				<form onSubmit={handleSubmit}>
				  <p className="text-gray-500 text-sm md:text-base mb-4 md:mb-6 text-center">
				...
				<div className="text-center">
				  <motion.div
					...
					className="w-12 h-12 md:w-16 md:h-16 bg-amber-200 rounded-full flex items-center justify-center mx-auto mb-4"
				  >
			...
			<div className="px-6 md:px-8 py-4 bg-amber-200 bg-opacity-50 flex justify-center">
			  <Link
				to={"/login"}
				className="text-sm text-black hover:underline flex items-center hover:font-medium"
			  >
